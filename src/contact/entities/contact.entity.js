...
var Contact = function () {
    ...
    var Contact = _classThis = /** @class */ (function () {
        function Contact_1() {
            this.contactId = __runInitializers(this, _contactId_initializers, void 0);
            this.name = (__runInitializers(this, _contactId_extraInitializers), __runInitializers(this, _name_initializers, void 0));
    ...
    (function () {
        ...
        _contactId_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)('uuid')];
        _name_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 100 })];
        _email_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 255 })];
        _phone_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 50 })];
        _description_decorators = [(0, typeorm_1.Column)({ type: 'text' })];
        _status_decorators = [(0, typeorm_1.Column)({
                type: 'enum',
                enum: contact_status_enum_1.ContactStatus,
                default: contact_status_enum_1.ContactStatus.PENDING,
            })];
        _propertyId_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 50 })];
