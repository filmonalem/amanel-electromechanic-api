...
var MailService = function () {
    ...
    var MailService = _classThis = /** @class */ (function () {
        function MailService_1(mailerService, configService) {
            this.mailerService = mailerService;
            this.configService = configService;
        }
        MailService_1.prototype.sendPasswordReset = function (email, token) {
            return __awaiter(this, void 0, void 0, function () {
                var resetUrl;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            resetUrl = "".concat(this.configService.get('FRONTEND_URL'), "/reset-password?token=").concat(token);
